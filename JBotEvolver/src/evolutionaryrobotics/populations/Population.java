...
public abstract class Population implements Serializable {
     ...
     * @param secondFitness 
     */
    public abstract void setEvaluationResult(Chromosome chromosome, double fitness, int secondFitness);
     ...
     * @param fitness
     */
    public abstract void setEvaluationResultForId(int pos, double fitness, int secondFitness);
    ...
    /** Get the last fitness obtained in the current generation.
    *
    * @return the last fitness obtained in the generation.
    */
   public abstract NEATPopulation4J getNEATPopulation4J();
	...
	*/
	...
	public synchronized static Population getPopulation(Arguments args) throws Exception {
		System.out.println("nkbwbkw");
		
        if(args.getArgumentIsDefined("load")){
        	
        	String str =args.getArgumentAsString("parentfolder");
