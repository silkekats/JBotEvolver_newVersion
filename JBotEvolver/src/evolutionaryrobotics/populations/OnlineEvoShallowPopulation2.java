...
public class OnlineEvoShallowPopulation2 extends Population implements Serializable {
	
	/**
	 * Could not access the other class in Eclipse this is just a copy of OnlineEvoShallowPopulation.java
	 */
	...
	public OnlineEvoShallowPopulation2(Arguments arguments) {
		super(arguments);
