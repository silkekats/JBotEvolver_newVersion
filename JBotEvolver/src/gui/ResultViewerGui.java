...
public class ResultViewerGui extends Gui implements Updatable {
    ...
    protected JTextField secondFitnessTextField;
	...
	protected JPanel initRightWrapperPanel() {
        ...
        statusPanel.add(new JLabel("Second Fitness: "));
        secondFitnessTextField = new JTextField("N/A");
        secondFitnessTextField.setHorizontalAlignment(JTextField.CENTER);
        secondFitnessTextField.setEditable(false);
        statusPanel.add(secondFitnessTextField);
